...
- **已翻译页面**：Settings、Sidebar、Scripts、Device、Notes、Case Editor、useTestCaseStore
- **未翻译/部分翻译**：CaseSpacePage（卡片列表）、FieldRulesPage（字段规则编辑）、WorkspacePage（已移除）
